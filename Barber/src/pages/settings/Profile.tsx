  ...
  return (
    <div className="grid gap-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 animate-fade-in-delayed">
        {/* Logo */}
        <div className="card">
          <h3 className="text-lg font-semibold text-text mb-4">Logo</h3>
          <div className="flex items-center gap-4">
            <div className="w-24 h-24 rounded-xl bg-surface border border-border flex items-center justify-center overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto p-4 md:p-8">
            ...
            <div className="grid gap-6">
              <div className="card">
                {/* Logo Upload */}
                <div className="mb-6">
                  <label className="block text-sm font-medium text-text mb-4">Logo da Barbearia</label>
                  <div className="flex items-center gap-4">
                    <div className="w-24 h-24 rounded-xl bg-surface border border-border flex items-center justify-center overflow-hidden">
                      <img
